...
docker pull inlets/inlets:2.7.0
...
curl -SLo $EXTENSION_DIR/guacamole-auth-totp-$GUAC_VER.tar.gz "http://apache.org/dyn/closer.cgi?action=download&filename=guacamole/$GUAC_VER/binary/guacamole-auth-totp-$GUAC_VER.tar.gz"
